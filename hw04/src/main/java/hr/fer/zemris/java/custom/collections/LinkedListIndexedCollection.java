...
public class LinkedListIndexedCollection<T> implements List<T> {
	...
	private static class ListNode<E> {
		 ...
		 */
		private ListNode(ListNode<E> previous, ListNode<E> next, E value) {
	...
	public void insert(T value, int position) {
		...
		ListNode<T> oldNode = getNode(position);
		ListNode<T> newNode = new ListNode<>(oldNode.previous, oldNode, value);
	...
	private static class LinkedListIterator<E> implements ElementsGetter<E> {
		...
		/**
		 * Current Node in a list defined by a {@link #position}.
		 */
		 ...
		 *         <code>null</code>.
		 */
		private LinkedListIterator(LinkedListIndexedCollection<E> col, long savedModificationCount) {
	...
	public ElementsGetter<T> createElementsGetter() {
		return new LinkedListIterator<T>(this, modificationCount);
	}
